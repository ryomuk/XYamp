...
オペアンプの帰還信号はコイルの前(オペアンプの出力そのもの)だけでは不十分で，コイル通過後の信号と両方使っています．Vectrexの回路でそうなっているので試してみたらうまくいったという次第なのですが，私はこのあたりの理屈はまだ理解できていません．一応動いてはいますが，まだ若干発振しているようで，修正の余地がありそうです．

## Z軸(輝度)用アンプ
![](images/sch_z.png)

watchmanのCRTはG1グリッドで輝度を調整しているようです．
sony-scopemanでは3.3V単電源のオペアンプの出力を継げているようだったので真似してみたのですがうまくいかず，いろいろ調べてみたところG1は±20Vぐらいの信号のようだったので±15Vのオペアンプを使ってScopetrexのZ信号を増幅することにしました．
